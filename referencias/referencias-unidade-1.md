...
FREEMAN, Eric; FREEMAN, Elisabeth. **Use a Cabeça! HTML com CSS e XHTML**. 2. ed. Rio de Janeiro: Alta Books, 2008.
...
* MDN Learn HTML: [Learn HTML](https://developer.mozilla.org/en-US/docs/Web/HTML)
