...
A disciplina de Desenvolvimento Web foi planejada para proporcionar ao estudante conhecimentos teóricos e práticos relacionados à criação de websites.

Durante o semestre serão estudadas tecnologias e ferramentas utilizadas por desenvolvedores e designers profissionais para o desenvolvimento de soluções digitais modernas.

O estudante terá contato com:
...
* Compreender os conceitos fundamentais relacionados ao desenvolvimento de websites.
* Planejar e estruturar projetos Web.
* Desenvolver interfaces utilizando HTML5 e CSS3.
* Criar layouts responsivos para diferentes dispositivos.
* Utilizar ferramentas que auxiliem no desenvolvimento Web.
...
As aulas serão desenvolvidas por meio de:
...
| Atividade                         |      Pontuação |
| --------------------------------- | -------------: |
| Atividade Individual (HTML e CSS) |      25 pontos |
| Exercícios Práticos Individuais   |      15 pontos |
| Trabalho Prático Individual (CMS) |      20 pontos |
